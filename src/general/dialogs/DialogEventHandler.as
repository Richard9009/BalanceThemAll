package general.dialogs 
{
	 ...
	 */
	public class DialogEventHandler extends EventDispatcher 
	{
		private static const SINGLETON_PASSCODE:String = "udhsy8723gddgey83746gdy92su4d";
		private static const instance:DialogEventHandler = new DialogEventHandler(null, SINGLETON_PASSCODE);
		
		private var eventsWeAreWaitingFor:Array = new Array();
		private var listeners:Array = new Array();
		
		public function DialogEventHandler(target:IEventDispatcher=null, pass:String = "secret") 
		{
			super(target);
			if (pass != SINGLETON_PASSCODE) throw new Error("Unable to create this object outside the class");
		}
		
		public static function getInstance():DialogEventHandler
		{
			return instance;
		}
		...
		override public function dispatchEvent(event:Event):Boolean 
		{
			...
			if (!thisIsTheEventWeAreWaitingFor(event.type)) return false;
